        ...
        <div class="app__container">
            <div class="grid__full-width container-top">
                <div class=" container-top__banner">
                    <img src="./accsets/img/banner.jpg" alt="banner" class="banner-img">
                </div>
                        ...
                        <div class=" main__content">
                            <div class="main__content-item main__content-item--bg1">
                                <div class="main__content-item-img">
                                    <img src="./accsets/img/dog.png" alt="" class="content-img">
                                </div>  
                                <div class="main__content-item-title">
                                    <p>Tiết Kiệm</p>
                                    <h2>25%</h2>
                                    <a href="product.html" class="main__content-btn">Thức ăn chó mèo</a>
                                </div>
                            </div>

                            <div class="main__content-item main__content-item--bg2">
                                <div class="main__content-item-img ">
                                    <img src="./accsets/img/cat.png" alt="" class="content-img">
                                </div>  
                                <div class="main__content-item-title">
                                    <p>Tư vấn</p>
                                    <h2>Miễn phí</h2>
                            ...
                            <div class="main__content-item main__content-item--bg3">
                                <div class="main__content-item-img">
                                    <img src="./accsets/img/dog2.png" alt="" class="content-img">
                                </div>  
                                <div class="main__content-item-title">
                                    <p>Có hạn</p>
                                    <p>Tiết kiệm đến</p>
                            ...
                            <ul class="content-product__list">
                                <li class="grid__column-2-5 content-product__item">
                                    <div class="content-product__img">
                                        <img src="./accsets/img/xucxich.png" alt="xúc xích" class="product__img">
                                    </div>
                        ...
                        <ul class="news-content__list">
                            <li class="news-content__item">
                                <div class="news-content__item-icon">
                                    <img src="./accsets/img/intro1.png" alt="" class="news-content__item-icon-img">
                                </div>
                            ...
                            <li class="news-content__item">
                                <div class="news-content__item-icon">
                                    <img src="./accsets/img/intro4.png" alt="" class="news-content__item-icon-img">
                                </div>
                                <div class="news-content__item-box">
                            ...
                            <li class="news-content__item">
                                <div class="news-content__item-icon">
                                    <img src="./accsets/img/intro2.png" alt="" class="news-content__item-icon-img">
                                </div>
                                <div class="news-content__item-box">
                            ...
                            <li class="news-content__item">
                                <div class="news-content__item-icon">
                                    <img src="./accsets/img/intro3.png" alt="" class="news-content__item-icon-img">
                                </div>
                                <div class="news-content__item-box">
